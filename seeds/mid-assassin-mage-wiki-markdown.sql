...
**나피리는 `Q`와 무리로 라인을 밀고 먼저 움직이기 좋지만, 밀었다는 이유만으로 매번 사이드로 달리면 동선이 읽힌다.** 상대 미드와 정글 위치, 강가 시야, 도착할 때 교전이 계속될지를 확인한다. 확실한 로밍이 아니면 시야에서 잠깐 사라져 압박만 주고 미드로 돌아와 다음 웨이브를 챙긴다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-23010eca-0af1-4ee2-a3a2-ac98f90fa9f9' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**다른 기본 기술은 `Q`의 재사용을 초기화하며, 두 개의 룬을 모은 뒤 `Q`를 쓰면 이동 속도를 얻는다.** 긴 맞대결을 계속하기보다 필요한 주문을 순서대로 사용하고 이 속도로 상대 사거리 밖으로 나가 짧은 교환을 완성한다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-67086497-75b0-4808-a001-3dddfeacc105' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**`E`로 웨이브를 밀면 둔화와 시야 확인 수단이 동시에 사라진다.** 상대 정글러 위치가 보이지 않을 때는 미니언 전체를 맞히겠다고 앞으로 던지지 말고, 라인이 안전한 위치로 돌아올 여지를 남긴다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-27bd0e78-66b0-4a9b-846a-32b18365e3ef' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**르블랑은 먼저 움직이면 사이드에 큰 압박을 주지만, 라인전이 강한 만큼 상대 정글의 집중 대상도 되기 쉽다.** `W`로 웨이브를 넣은 뒤 아군과 적 정글 위치, 강가 시야를 확인한다. 혼자 깊이 들어가기보다 정글과 함께 적 정글 입구나 사이드를 압박하고, 웨이브를 끝까지 못 밀었다면 무리한 로밍 대신 라인을 당겨 갱 각을 만든다.', revision = 4, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-ai-champion-leblanc-20260911' AND revision = 4 AND general = '# 미드 라인 실전 운용
...
**`Q`, `W`, `E`가 여러 미니언을 건드리기 쉬워 짧은 견제도 웨이브를 밀 수 있다.** 로밍하려면 빠르게 끝까지 밀고 움직이고, 정글러 갱을 받으려면 챔피언만 맞는 `Q` 각을 사용해 라인이 아군 쪽에 남도록 한다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-132c9ef9-8e8b-4aff-8e16-2e4098465398' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**제압은 정글러의 접근과 피해를 확정하는 데 특히 강하다.** 라인이 아군 쪽에 있고 정글러가 가까울 때가 가장 단순한 킬 각이다. 반대로 큰 미니언 웨이브를 적 포탑에 넣은 상태에서 혼자 궁을 시작하면 주변 적에게 쉽게 끊기므로 위치부터 확인한다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-077fa2c7-41b2-4620-ae2c-185b81fe54d1' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**빛의 세례는 한 지점에 피해가 반복되는 기술이라 자유롭게 움직이는 상대에게는 효율이 떨어진다.** `E`의 속박·둔화나 아군의 제어가 확인된 뒤 사용하고, `Q`와 `E`를 동시에 빗맞힌 상태에서는 강화 공격을 넣겠다고 앞으로 나가지 않는다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-5bd97d30-0917-495d-b049-bb438235d231' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**견제 한 번을 위해 `Q` 막타와 좋은 라인 위치를 동시에 잃지 않는다.** 상대가 기술을 미니언에 사용했을 때만 짧게 압박하고, 위협적인 진입기가 남아 있으면 `E`를 보존한 채 포탑 쪽에서 성장한다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-bed696ba-2310-4820-9cf4-ee5c34ae55a2' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**더 먼 거리에서 웨이브와 체력을 동시에 압박하는 상대에게 계속 정면 교환을 걸면 손해가 누적된다.** 안전한 순간에 라인을 정리하고 시야 밖으로 사라져 정글러와 움직이면 벡스의 진입 위협을 살릴 수 있다. 궁극기가 맞아도 불리한 위치라면 재사용하지 않는다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-80df8739-7bdf-428b-9789-58571366b198' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**초반 재사용 대기시간이 길 때 무리한 연속 교환을 하면 빈 시간이 크다.** 사거리로 체력을 조금씩 깎되, 킬을 위해 앞으로 나가기보다 체력과 미니언을 보존해 안정적으로 성장하는 것을 우선한다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-f1404d69-50a3-4c61-9452-d31dd292564a' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**신드라의 긴 연계는 첫 제어기가 적중했을 때 강하다.** `Q`나 `W`가 빗나갔는데도 `E`를 추가로 소모하면 상대가 들어올 긴 빈틈만 생긴다. 실패한 교환은 즉시 끊고 다음 구체 배치를 준비한다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-908b088a-d7ea-4d7a-bdc5-3c47ada13b5e' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**초반부터 모든 `Q`를 미니언과 챔피언에게 동시에 맞히려 하면 마나와 체력을 함께 잃기 쉽다.** 라인을 밀 목적이라면 먼저 강가 시야와 상대 위치를 확인하고, 싸울 목적이라면 미니언 체력이 낮아 상대가 막타를 치는 순간을 노린다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-2df64efd-93e1-4656-bddf-8f305f5df8cc' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**`E` 안의 미니언과 `Q` 적중으로 별가루를 얻더라도, 그 과정에서 체력을 크게 잃으면 다음 웨이브를 먹지 못한다.** 위험한 미니언 몇 개는 포기하고 라인을 아군 쪽으로 받아 성장 시간을 확보한다. 초반에 쓰러지지 않는 것이 가장 안정적인 성장 수단이다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-f1945b6e-3dee-45ee-b457-00c5384aa05c' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**아지르의 강한 지속 피해는 상대가 병사 공격 범위에 머물 때 나온다.** 체력이 조금 남았다고 병사를 뒤에 두고 본체만 앞으로 걸으면 평범한 원거리 챔피언이 된다. 상대가 범위를 벗어나면 라인 주도권과 체력 이득을 챙기고 멈춘다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-5fc0f788-ca1b-4024-86b9-1d459c56490c' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**아칼리는 라인을 무조건 빨리 지우기보다 체력과 기력을 보존하며 움직일 파동을 고르는 편이 안전하다.** 웨이브를 상대 포탑에 넣었거나 상대가 귀환한 순간에 강가를 본다. 먼저 사라지겠다고 큰 웨이브를 버리면 실패한 로밍 뒤 성장이 끊긴다. 가능하면 정글과 같은 방향으로 움직여 짧은 교전을 만든다.', revision = 4, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-ai-champion-akali-20260911' AND revision = 4 AND general = '# 미드 라인 실전 운용
...
**애니보다 긴 거리에서 견제하는 상대에게 정면으로 걸어가면 체력을 잃고 시작한다.** 기절을 보유한 채 미니언을 챙기고, 상대가 라인 정리 기술을 쓴 순간이나 정글러가 도착했을 때 확정 제어를 연결한다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-65d0b98e-aca6-4035-a3bf-d7fd4faa29cf' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**동상은 `Q` 기절이나 충분히 형성된 궁극기로 냉기가 묻은 대상에게 강해진다.** 냉기 없이 `E`부터 던지는 교환은 마나 대비 효율이 낮다. 궁극기를 라인에 오래 유지할 때는 상대 정글러가 들어올 경로와 남은 마나를 함께 본다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-7f7d1f23-aefd-455d-995a-3d8fbb3539e5' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**지속 효과를 완성하면 이득이 크지만 마지막 한 번을 넣으려고 미니언을 넘어가면 상대의 전체 연계를 맞을 수 있다.** 안전한 `Q` 회수나 기본 공격 각이 아니면 교환을 끊고 다음 주기를 기다린다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-2899fe45-3c51-4058-9487-26242464d8de' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**`E`는 보호막을 주고 공이 돌아오는 경로의 적에게 피해를 준다.** `Q`-`W` 견제 뒤 상대가 반격할 때 `E`로 보호막을 받으며 공을 회수하면 손해를 줄일 수 있다. 공이 돌아온 뒤에는 압박 가능한 위치가 달라졌다는 점을 잊지 않는다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-0d4c7c07-b905-472f-9b4a-b4a94f0f08cb' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**제드는 라인을 먼저 정리하면 강가 합류와 로밍 두 선택을 상대에게 동시에 보여 줄 수 있다.** 반대로 웨이브를 남겨 두고 사라졌다가 성과 없이 돌아오면 경험치 손해가 크다. 이동 전에는 상대 미드가 따라올 길과 아군 정글 위치를 보고, 혼자 깊이 들어가기보다 정글과 같은 방향으로 움직인다.', revision = 4, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-ai-champion-zed-20260911' AND revision = 4 AND general = '# 미드 라인 실전 운용
...
**스킬로 웨이브를 지우면 자연스럽게 라인이 상대 쪽으로 간다.** 도주기가 없는 제라스는 한쪽 강가에 시야를 만들고 그쪽에 가깝게 서야 한다. 양쪽이 모두 보이지 않으면 상대 체력을 깎는 것보다 웨이브가 돌아오도록 기다리는 편이 낫다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-d804656d-2129-4e55-b28c-658608efa1fd' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**조이는 좁은 길과 벽 너머에서 위협이 커진다.** 웨이브를 먼저 정리했다면 상대 포탑 앞에서 무리한 견제를 반복하기보다 정글러와 함께 강가 시야를 잡아 다음 수면 각을 만든다. 라인이 밀려 있는데 먼저 움직이면 경험치 손해가 더 크다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-cc54cdde-cfcc-479d-9737-2b26f152b569' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**정면을 보는 적은 기절하지만 등을 돌린 적에게도 둔화가 걸린다.** 완벽한 정면 기절만 기다리다 죽기보다, 상대가 달라붙었을 때 즉시 공간을 만들고 `W`와 `Q`를 이어가는 판단도 필요하다. 여러 방향에서 적이 오는 위치는 피한다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-0e9226b2-5491-42cb-b678-0d9219f200c4' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**먼저 라인을 밀어야 움직일 권리가 생긴다.** 맵을 자주 보되 바텀에서 싸움이 날 것 같다는 이유만으로 바로 내려가지는 않는다. 상대 미드와 정글의 위치, 지나갈 길의 와드, 도착했을 때 교전이 계속될지를 확인한다. 가능하면 아군 정글과 같이 움직이고, 상대가 길을 막고 있는데 혼자 강으로 들어가지 않는다. 라인을 밀지 못한 채 실패한 로밍은 미니언과 체력을 모두 잃는 큰 손해다.', revision = 4, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-ai-champion-katarina-20260911' AND revision = 4 AND general = '# 미드 라인 실전 운용
...
**키아나는 강과 벽 근처 소규모 교전이 강하지만, 로밍에 집착해 미드 웨이브를 계속 버리면 다음 싸움의 피해가 부족해진다.** 라인을 상대 포탑에 넣은 뒤 아군 정글과 같은 방향으로 움직인다. 상대가 먼저 사라졌다면 무작정 따라가기보다 위험 핑을 찍고 반대쪽 시야나 웨이브에서 확실한 이득을 고른다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-3425cc0c-770c-44fb-9e75-434bc8f27357' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**탈론은 벽을 넘어 빠르게 합류할 수 있지만, 이동 속도가 빠른 것과 로밍 비용이 없는 것은 다르다.** 먼저 웨이브를 상대 포탑에 넣고 아군 정글과 같은 방향으로 움직인다. 갈 길과 돌아올 길을 다르게 잡으면 동선이 덜 읽히고, 실패해도 다음 웨이브에 복귀하기 쉽다. 라인을 못 밀었다면 사라지는 척만 하고 미드 압박을 이어 간다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-0b3be62a-0b48-461d-8bef-96e5057ae96d' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**탈리야는 웨이브를 정리하고 벽을 따라 먼저 움직일 때 강하다.** 미니언이 남아 있는데 시야에서 사라지면 로밍이 실패했을 때 손해가 크다. 먼저 웨이브를 포탑에 넣고 정글러 위치를 확인한 뒤 강가로 움직인다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-6ac51090-21cb-4daf-a0c6-66e8482021c5' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**다른 라인에 기회가 보여도 미니언을 포탑에 넣지 않고 이동하면 상대 미드가 손쉽게 경험치와 포탑 피해를 챙긴다.** 먼저 웨이브를 밀고 상대 위치를 확인한 뒤 이동한다. 도착 지점도 적 바로 위보다 퇴로나 아군과 합류할 수 있는 쪽이 안전하다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-cfa6e563-1fcd-4407-b0f7-bf98b68fa239' AND revision = 3 AND general = '# 미드 라인 실전 운용
...
**`E`로 라인을 정리하면 빠르게 움직일 수 있지만, 곧바로 강가에서 적을 만나면 피할 도구가 없다.** 웨이브를 넣은 뒤 `E`가 돌아올 시간과 상대 정글 위치를 함께 본다. 궁극기가 있으면 아군 정글과 같은 방향으로 움직여 퇴로가 좁은 적을 노리고, 궁이 빗나가면 계획대로 억지 진입하지 않는다.', revision = 4, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-ai-champion-fizz-20260911' AND revision = 4 AND general = '# 미드 라인 실전 운용
...
**흐웨이는 멀리서 라인을 건드릴 수 있지만 이동기가 없다.** 파멸과 고통 기술을 한 번에 빗맞히면 상대가 들어오는 동안 막을 방법이 적다. 첫 제어가 빗나가면 추가 기술을 억지로 잇지 않고 거리를 다시 만든다.', revision = 3, updated_at = '2026-09-13T00:00:00.000Z', updated_by = 'user-system'
...
FROM wiki_docs WHERE id = 'doc-a-12ad2a64-3bb7-489e-8ccb-459432858e90' AND revision = 3 AND general = '# 미드 라인 실전 운용
